...
class PurchaseRequestLineForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'usage_description', 'suggested_supplier'
        ]
        widgets = {
...
class DeliveryLineForm(forms.ModelForm):
    ...
    class Meta:
        model = DeliveryLine
        fields = ['product', 'received_quantity', 'unit_price', 'quality_status', 'notes']
...
class DeliveryLineInline(admin.TabularInline):
    ...
    fields = [
        ...
        'unit_price', 'quality_status', 'line_total_display'
    ]
    readonly_fields = ['line_number', 'line_total_display']
...
class DeliveryReceiptAdmin(admin.ModelAdmin):
    ...
    list_display = [
        ...
        'quality_check_status', 'grand_total_display'
    ]

    list_filter = [
        'status', 'quality_check_status', 'delivery_date', 'supplier'
    ]
