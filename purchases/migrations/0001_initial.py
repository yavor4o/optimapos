    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('submitted', 'Submitted'), ('approved', 'Approved'), ('confirmed', 'Confirmed'), ('sent', 'Sent'), ('received', 'Received'), ('cancelled', 'Cancelled'), ('closed', 'Closed')], default='draft', max_length=20, verbose_name='Status')),
                ('delivery_date', models.DateField(help_text='When goods were/will be delivered', verbose_name='Delivery Date')),
                ('supplier_document_number', models.CharField(blank=True, help_text="Supplier's invoice/delivery note number", max_length=50, verbose_name='Supplier Document Number')),
                ...
                ('order_reference', models.CharField(blank=True, help_text='Internal reference number for this order', max_length=100, verbose_name='Order Reference')),
                ...
                ('location', models.ForeignKey(help_text='Delivery/receiving location', on_delete=django.db.models.deletion.PROTECT, to='inventory.inventorylocation', verbose_name='Location')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('creation_type', models.CharField(choices=[('from_orders', 'From Orders'), ('direct', 'Direct Delivery'), ('mixed', 'Mixed')], help_text='How this delivery was created', max_length=20, verbose_name='Creation Type')),
                ('delivery_note_number', models.CharField(blank=True, help_text="Supplier's delivery note/dispatch number", max_length=100, verbose_name='Delivery Note Number')),
                ('vehicle_info', models.CharField(blank=True, help_text='Delivery vehicle details (license plate, etc.)', max_length=100, verbose_name='Vehicle Information')),
                ...
                ('received_at', models.DateTimeField(blank=True, help_text='When the delivery was physically received', null=True, verbose_name='Received At')),
                ('processed_at', models.DateTimeField(blank=True, help_text='When the delivery was fully processed in system', null=True, verbose_name='Processed At')),
                ('quality_checked', models.BooleanField(default=False, help_text='Whether quality control has been performed', verbose_name='Quality Checked')),
                ('quality_approved', models.BooleanField(default=True, help_text='Overall quality approval status', verbose_name='Quality Approved')),
                ('has_quality_issues', models.BooleanField(default=False, help_text='Whether any items failed quality control', verbose_name='Has Quality Issues')),
                ('quality_notes', models.TextField(blank=True, help_text='Quality control notes and observations', verbose_name='Quality Notes')),
                ('has_variances', models.BooleanField(default=False, help_text='Whether there are differences between ordered and received', verbose_name='Has Variances')),
                ('variance_notes', models.TextField(blank=True, help_text='Explanation of variances between ordered and received', verbose_name='Variance Notes')),
                ('supplier_invoice_reference', models.CharField(blank=True, help_text='Reference to supplier invoice (for finance app integration)', max_length=100, verbose_name='Supplier Invoice Reference')),
                ('has_supplier_invoice', models.BooleanField(default=False, help_text='Whether this delivery came with supplier invoice', verbose_name='Has Supplier Invoice')),
                ('requires_cold_storage', models.BooleanField(default=False, help_text='Whether items require refrigerated storage', verbose_name='Requires Cold Storage')),
                ('is_urgent_delivery', models.BooleanField(default=False, help_text='Whether this is an urgent/priority delivery', verbose_name='Urgent Delivery')),
                ('special_handling_notes', models.TextField(blank=True, help_text='Special handling requirements or notes', verbose_name='Special Handling Notes')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='created_%(class)s_documents', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('location', models.ForeignKey(help_text='Delivery/receiving location', on_delete=django.db.models.deletion.PROTECT, to='inventory.inventorylocation', verbose_name='Location')),
                ('quality_inspector', models.ForeignKey(blank=True, help_text='User who performed quality inspection', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='inspected_deliveries', to=settings.AUTH_USER_MODEL, verbose_name='Quality Inspector')),
                ('received_by', models.ForeignKey(help_text='User who received and processed this delivery', on_delete=django.db.models.deletion.PROTECT, related_name='received_deliveries', to=settings.AUTH_USER_MODEL, verbose_name='Received By')),
                ('supplier', models.ForeignKey(help_text='The supplier for this document', on_delete=django.db.models.deletion.PROTECT, to='partners.supplier', verbose_name='Supplier')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='updated_%(class)s_documents', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
                ('source_orders', models.ManyToManyField(blank=True, help_text='Orders this delivery is based on (if any)', related_name='deliveries', to='purchases.purchaseorder', verbose_name='Source Orders')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.DecimalField(decimal_places=3, help_text='Quantity in the specified unit', max_digits=10, verbose_name='Quantity')),
                ('quantity_base_unit', models.DecimalField(decimal_places=3, default=Decimal('0.000'), help_text='Automatically calculated quantity in product base unit', max_digits=10, verbose_name='Quantity (Base Unit)')),
                ('unit_price', models.DecimalField(decimal_places=4, help_text='Price per unit', max_digits=10, verbose_name='Unit Price')),
                ('unit_price_base', models.DecimalField(decimal_places=4, default=Decimal('0.0000'), help_text='Price per base unit - automatically calculated', max_digits=10, verbose_name='Unit Price (Base)')),
                ...
                ('discount_amount', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Calculated discount amount', max_digits=10, verbose_name='Discount Amount')),
                ('final_unit_price', models.DecimalField(decimal_places=4, default=Decimal('0.0000'), help_text='Unit price after discount', max_digits=10, verbose_name='Final Unit Price')),
                ('line_total', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Total for this line after discount', max_digits=12, verbose_name='Line Total')),
                ('vat_amount', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='VAT amount for this line', max_digits=12, verbose_name='VAT Amount')),
                ...
                ('quality_approved', models.BooleanField(default=True, help_text='Whether this line passed quality control', verbose_name='Quality Approved')),
                ('quality_notes', models.TextField(blank=True, help_text='Notes about quality issues or inspections', verbose_name='Quality Notes')),
                ...
                ('confirmed_price', models.DecimalField(blank=True, decimal_places=4, help_text='Price confirmed by supplier (if different from quoted)', max_digits=10, null=True, verbose_name='Confirmed Price')),
                ('confirmed_delivery_date', models.DateField(blank=True, help_text='Delivery date confirmed by supplier', null=True, verbose_name='Confirmed Delivery Date')),
                ('supplier_product_code', models.CharField(blank=True, help_text="Supplier's code for this product", max_length=50, verbose_name='Supplier Product Code')),
                ('supplier_product_name', models.CharField(blank=True, help_text="Supplier's name for this product", max_length=200, verbose_name='Supplier Product Name')),
                ('delivery_status', models.CharField(choices=[('pending', 'Pending'), ('partial', 'Partially Delivered'), ('completed', 'Fully Delivered'), ('cancelled', 'Cancelled')], default='pending', help_text='Delivery status of this specific line', max_length=20, verbose_name='Line Delivery Status')),
                ('delivered_quantity', models.DecimalField(decimal_places=3, default=Decimal('0.000'), help_text='Total quantity delivered so far', max_digits=10, verbose_name='Delivered Quantity')),
                ('remaining_quantity', models.DecimalField(decimal_places=3, default=Decimal('0.000'), help_text='Quantity still pending delivery', max_digits=10, verbose_name='Remaining Quantity')),
                ('special_instructions', models.TextField(blank=True, help_text='Special handling or delivery instructions for this line', verbose_name='Special Instructions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quality_approved', models.BooleanField(default=True, help_text='Whether this line passed quality control', verbose_name='Quality Approved')),
                ('quality_notes', models.TextField(blank=True, help_text='Notes about quality issues or inspections', verbose_name='Quality Notes')),
                ('ordered_quantity', models.DecimalField(blank=True, decimal_places=3, help_text='Original ordered quantity (if from order)', max_digits=10, null=True, verbose_name='Ordered Quantity')),
                ('received_quantity', models.DecimalField(decimal_places=3, help_text='Actually received quantity', max_digits=10, verbose_name='Received Quantity')),
                ...
                ('quality_issue_type', models.CharField(blank=True, choices=[('damaged', 'Damaged'), ('expired', 'Expired'), ('wrong_product', 'Wrong Product'), ('poor_quality', 'Poor Quality'), ('packaging_issue', 'Packaging Issue'), ('contaminated', 'Contaminated'), ('other', 'Other')], help_text='Type of quality issue if any', max_length=50, verbose_name='Quality Issue Type')),
                ('rejection_reason', models.TextField(blank=True, help_text='Detailed reason for rejecting this line', verbose_name='Rejection Reason')),
                ('storage_location', models.CharField(blank=True, help_text='Where this item was stored after receiving', max_length=100, verbose_name='Storage Location')),
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='products.product', verbose_name='Product')),
                ('quality_checked_by', models.ForeignKey(blank=True, help_text='User who performed quality check on this line', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='quality_checked_lines', to=settings.AUTH_USER_MODEL, verbose_name='Quality Checked By')),
                ('unit', models.ForeignKey(help_text='Unit of measure for this line', on_delete=django.db.models.deletion.PROTECT, to='nomenclatures.unitofmeasure', verbose_name='Unit')),
                ...
                ('source_order_line', models.ForeignKey(blank=True, help_text='Order line this delivery line was created from (if any)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='delivery_lines', to='purchases.purchaseorderline', verbose_name='Source Order Line')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('approved_at', models.DateTimeField(blank=True, help_text='When the request was approved', null=True, verbose_name='Approved At')),
                ('urgency_level', models.CharField(choices=[('normal', 'Normal'), ('urgent', 'Urgent'), ('emergency', 'Emergency')], default='normal', help_text='Priority level for this request', max_length=20, verbose_name='Urgency Level')),
                ('request_type', models.CharField(choices=[('regular', 'Regular Replenishment'), ('new_product', 'New Product'), ('promotional', 'Promotional Stock'), ('emergency', 'Emergency Stock'), ('seasonal', 'Seasonal Stock')], default='regular', help_text='Type of purchase request', max_length=20, verbose_name='Request Type')),
                ('business_justification', models.TextField(blank=True, help_text='Reason for this purchase request', verbose_name='Business Justification')),
                ('expected_usage', models.TextField(blank=True, help_text='How the requested items will be used', verbose_name='Expected Usage')),
                ('approval_required', models.BooleanField(default=True, help_text='Whether this request requires approval', verbose_name='Approval Required')),
                ('approval_amount_limit', models.DecimalField(blank=True, decimal_places=2, help_text='Amount limit that triggered approval requirement', max_digits=12, null=True, verbose_name='Approval Amount Limit')),
                ('rejection_reason', models.TextField(blank=True, help_text='Reason for rejecting this request', verbose_name='Rejection Reason')),
                ('converted_at', models.DateTimeField(blank=True, help_text='When this request was converted to order', null=True, verbose_name='Converted At')),
                ('approved_by', models.ForeignKey(blank=True, help_text='User who approved this request', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='approved_purchase_requests', to=settings.AUTH_USER_MODEL, verbose_name='Approved By')),
                ('converted_by', models.ForeignKey(blank=True, help_text='User who converted this request to order', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='converted_purchase_requests', to=settings.AUTH_USER_MODEL, verbose_name='Converted By')),
                ('converted_to_order', models.ForeignKey(blank=True, help_text='Order created from this request', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='originating_request', to='purchases.purchaseorder', verbose_name='Converted to Order')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='created_%(class)s_documents', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('location', models.ForeignKey(help_text='Delivery/receiving location', on_delete=django.db.models.deletion.PROTECT, to='inventory.inventorylocation', verbose_name='Location')),
                ('requested_by', models.ForeignKey(help_text='User who created this request', on_delete=django.db.models.deletion.PROTECT, related_name='purchase_requests', to=settings.AUTH_USER_MODEL, verbose_name='Requested By')),
                ('supplier', models.ForeignKey(help_text='The supplier for this document', on_delete=django.db.models.deletion.PROTECT, to='partners.supplier', verbose_name='Supplier')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='updated_%(class)s_documents', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='source_request',
            field=models.ForeignKey(blank=True, help_text='Request this order was created from (if any)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='purchases.purchaserequest', verbose_name='Source Request'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quality_approved', models.BooleanField(default=True, help_text='Whether this line passed quality control', verbose_name='Quality Approved')),
                ('quality_notes', models.TextField(blank=True, help_text='Notes about quality issues or inspections', verbose_name='Quality Notes')),
                ('requested_quantity', models.DecimalField(decimal_places=3, help_text='Originally requested quantity', max_digits=10, verbose_name='Requested Quantity')),
                ('current_stock_level', models.DecimalField(decimal_places=3, default=Decimal('0.000'), help_text='Stock level when request was created', max_digits=10, verbose_name='Current Stock Level')),
                ('minimum_stock_level', models.DecimalField(decimal_places=3, default=Decimal('0.000'), help_text='Minimum stock level for this product', max_digits=10, verbose_name='Minimum Stock Level')),
                ('estimated_price', models.DecimalField(blank=True, decimal_places=4, help_text='Estimated unit price', max_digits=10, null=True, verbose_name='Estimated Price')),
                ('line_justification', models.TextField(blank=True, help_text='Specific reason for requesting this item', verbose_name='Line Justification')),
                ('converted_to_order_line', models.ForeignKey(blank=True, help_text='Order line created from this request line', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='originating_request_line', to='purchases.purchaseorderline', verbose_name='Converted to Order Line')),
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='products.product', verbose_name='Product')),
                ('suggested_supplier', models.ForeignKey(blank=True, help_text='Recommended supplier for this product', null=True, on_delete=django.db.models.deletion.SET_NULL, to='partners.supplier', verbose_name='Suggested Supplier')),
                ('unit', models.ForeignKey(help_text='Unit of measure for this line', on_delete=django.db.models.deletion.PROTECT, to='nomenclatures.unitofmeasure', verbose_name='Unit')),
            ],
            options={
