...
var KTDropdown = /** @class */ (function (_super) {
    ...
    function KTDropdown(element, config) {
        ...
        if (!_this._menuElement)
            return _this;
        KTData.set(_this._menuElement, 'dropdownElement', _this._element);
    ...
    KTDropdown.prototype._show = function () {
        ...
        this._initPopper();
        KTDom.transitionEnd(this._menuElement, function () {
            _this._isTransitioning = false;
            _this._isOpen = true;
    ...
    KTDropdown.prototype._initPopper = function () {
        ...
        if (reference) {
            var popper = createPopper(reference, this._menuElement, this._getPopperConfig());
    ...
    KTDropdown.handleMouseover = function () {
        KTEventHandler.on(document.body, '[data-kt-dropdown-toggle], [data-kt-dropdown-menu]', 'mouseover', function (event, target) {
    ...
    KTDropdown.handleMouseout = function () {
        KTEventHandler.on(document.body, '[data-kt-dropdown-toggle], [data-kt-dropdown-menu]', 'mouseout', function (event, target) {
            var dropdown = KTDropdown.getInstance(target);
            if (dropdown && dropdown._getOption('trigger') === 'hover') {
    ...
    KTDropdown.handleClick = function () {
        KTEventHandler.on(document.body, '[data-kt-dropdown-toggle]', 'click', function (event, target) {
            var dropdown = KTDropdown.getInstance(target);
            if (dropdown) {
    ...
    KTDropdown.handleDismiss = function () {
        KTEventHandler.on(document.body, '[data-kt-dropdown-dismiss]', 'click', function (event, target) {
            var dropdown = KTDropdown.getInstance(target);
            if (dropdown) {
                dropdown.hide();
            }
