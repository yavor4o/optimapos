# Generated by Django 5.2.3 on 2025-07-15 15:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_group_prices', to='pricing.pricegroup', verbose_name='Price Group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('customer_groups', models.ManyToManyField(blank=True, help_text='Limit promotion to specific customer groups (leave empty for all)', related_name='promotions', to='pricing.pricegroup', verbose_name='Customer Groups')),
