...
urlpatterns = [
    ...
    path('product-groups/', include([
        ...
        path('create.html/', views.ProductGroupCreateView.as_view(), name='product_groups_create'),
    ...
    path('brands/', include([
        ...
        path('create.html/', views.BrandCreateView.as_view(), name='brands_create'),
    ...
    path('product-types/', include([
        ...
        path('create.html/', views.ProductTypeCreateView.as_view(), name='product_types_create'),
    ...
    path('currencies/', include([
        ...
        path('create.html/', views.CurrencyCreateView.as_view(), name='currencies_create'),
    ...
    path('tax-groups/', include([
        ...
        path('create.html/', views.TaxGroupCreateView.as_view(), name='tax_groups_create'),
    ...
    path('price-groups/', include([
        ...
        path('create.html/', views.PriceGroupCreateView.as_view(), name='price_groups_create'),
    ...
    path('document-types/', include([
        ...
        path('create.html/', views.DocumentTypeCreateView.as_view(), name='document_types_create'),
