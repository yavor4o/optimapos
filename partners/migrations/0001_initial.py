    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='Short unique code for this partner (e.g. ABC, PIXEL)', max_length=20, unique=True, verbose_name='Partner Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='customers', to='nomenclatures.pricegroup', verbose_name='Price Group')),
            ],
            options={
